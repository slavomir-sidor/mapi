...
/**
 * SS MAPI Bundle Command Code Generator DTD Element
 *
 * @licence GNU GPL
 * 
...
use SS\MAPIBundle\DTD\Source;
use SS\MAPIBundle\Service\Code\Generator\DTD\Element as ElementGenerator;

class Element extends AbstractGenerator
{

	/**
	 * SS MAPI Bundle Command Code Generator DTD Element Generator
	 *
	...
	protected function configure()
	{
		...
		$this->addArgument( 'elementParentClass', InputArgument::OPTIONAL, 'Element Parent Class', '\\SS\\MAPIBundle\\DTD\\Element' );
		...
		OutputInterface $output )
	{
		...
		foreach( $items as $item )
		{
			...
			$docblock = new DocBlockGenerator( 
				...
				"", 
				array( 
					new Tag( "author", "SS MAPI Generator " . $datetime->format( "d.m.Y h:m:s" ) ),

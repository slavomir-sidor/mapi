 ...
 */
namespace SS\MAPIBundle\Command\Mylyn;

use SS\MAPIBundle\Command\Code\Reflection\ReflectionCommand;
	...
	protected function getRows()
	{
		if( null === $this->rows )
		{
			...
			foreach( $files as $row )
			{
				...
				$task = $serializer->deserialize( $xmldoc->saveXML(), 'SS\MAPIBundle\Mylyn\ContextState', 'xml' );

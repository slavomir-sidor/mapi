...
class FilesystemController extends AbstractController
{
	...
	{
		return $this->render( 'SSMAPIBundle:Filesystem:toolbar.html.twig', $this->getModel() );
	}

	public function workspace()
	{
		return $this->render( 'SSMAPIBundle:Filesystem:workspace.html.twig', $this->getModel() );
	}

	public function create()
	{
		return $this->render( 'SSMAPIBundle:Filesystem:Create/index.html.twig', $this->getModel() );
	}

	public function edit()
	{
		return $this->render( 'SSMAPIBundle:Filesystem:Edit/index.html.twig', $this->getModel() );
	}

	public function save()
	{
		return $this->render( 'SSMAPIBundle:Filesystem:Save/index.html.twig', $this->getModel() );
	}

	public function detail()
	{
		$model = $this->getModel();
		return $this->render( 'SSMAPIBundle:Filesystem:Detail/index.html.twig', $model );
	}

	public function delete()
	{
		return $this->render( 'SSMAPIBundle:Filesystem:Delete/index.html.twig', $this->getModel() );
	}

<?php
namespace SS\MAPIBundle\Service\Code\Generator\Collection;

use TokenReflection\Php\ReflectionProperty;
use SS\MAPIBundle\Service\Code\Reflection\Collection\AttributesCollection as ReflectionAttributesCollection;

 ...
 */
namespace SS\MAPIBundle\Command;

use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;
use Psr\Log\LoggerInterface;
use SS\MAPIBundle\Service\Table\Adapter\TXT;
use SS\MAPIBundle\Service\Table\Adapter\SpreedSheet;
...
abstract class AbstractCommand extends Command
{
	 ...
	 * @param int $verbosity
	 * @param OutputInterface $output
	 * @see \SS\MAPIBundle\Command\AbstractCommand
	 */
	 ...
	 * @param OutputInterface $output
	 * @see \SS\MAPIBundle\Command\AbstractCommand SS MAPI Bundle Abstract Command
	 */
